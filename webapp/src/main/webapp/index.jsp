...
<html>
    <head>
        ...
        <title>Diyan Virtual Works...</title>
...
<body>
    ...
    <div class="sequence">
      ...
      <div class="seq-preloader">
        ...
        <nav>
          <div class="logo">
              <img src="img/diyan.png" alt="">
          </div>
          <div class="mini-logo">
              <img src="img/mini_logo_diyan.png" alt="">
          </div>
          <ul>
            <li><a href="#1"><i class="fa fa-home"></i> <em>Home</em></a></li>
            <li><a href="#2"><i class="fa fa-user"></i> <em>About</em></a></li>
            <li><a href="#3"><i class="fa fa-pencil"></i> <em>Our Clients</em></a></li>
          ...
          <div class="slide" id="1">
            <div class="content first-content">
              <div class="container-fluid">
                  <div class="col-md-3">
                      <div class="author-image"><img src="img/dinesh.jpg" alt="Author Image"></div>
                  </div>
                  <div class="col-md-9">
                      <h2>Diyan Creations</h2>
                      <p>"A Place to fuel all your creative weds"<br>We are a group of entreprenuers working together in this dream project. We are a one stop destiny to all your creative and digital intrests. We include all photography, videography, make up, tattoos, digital painting, frame works, pencil art, albums, gift materials and etc..<br>As the world is moving more digitally day-by-day, we should also start to build our income digitally. Thus we also undertake trading and also do partnership trading investments with conditions.</p>
                ...
                <div class="container-fluid">
                    <div class="col-md-6">
                        <div class="left-content">
                            <h2>About Us</h2>
                            <p>Hey Please tell your friends about templatemo website. A variety of free CSS templates are available for immediate downloads.</p> 
...
[O                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="left-content">
                                                ...
                                                <div class="fb-btn"><a rel="nofollow" href="https://www.instagram.com/mr.360_studio/">Instagram</a></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="right-image">
                                                <img src="img/mr 360 jj.jpg" alt="first service">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="left-image">
                                                <img src="img/ganapathy.jpg" alt="second service">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="right-content">
                                                <h2>Imprison Studio</h2>
                            ...
                            <div class="third-section">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="left-content">
                                                <h2>Divi Makeup Artistry</h2>
                                                <p>Vestibulum augue ex, finibus sit amet nisi id, maximus ultrices ipsum. Maecenas rhoncus nibh in mauris lobortis, a maximus diam faucibus. In et eros urna. Suspendisse potenti. Pellentesque commodo, neque nec molestie tempus, purus ante feugiat augue.</p>
                                                <div class="fb-btn"><a rel="nofollow" href="https://www.instagram.com/divimakeupartistry/">Instagram</a></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="right-image">
                                                <img src="img/divi.jpg" alt="third service">
                                            </div>
                                        </div>
                                    </div>
                                </div>
	...
	-->
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1633.6171054595773!2d80.19897995521369!3d13.136002141593055!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a52648fe3ff918d%3A0x429229d0fa5a2e6a!2sSairam%20Nagar%2C%20Lakshmipuram%2C%20Chennai%2C%20Tamil%20Nadu%20600099!5e0!3m2!1sen!2sin!4v1661871612031!5m2!1sen!2sin" width="100%" height="500px" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="footer">
          <div class="content">
              <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Diyan Virtual Works</p>
          </div>
        </div>
